...
#A leparszolt dependencia blokkok beolvasasa 
#(D:/Onlab/ADJP_generalas/Input/adjp_output_deps.txt)
f= open('D:/Onlab/ADJP_generalas/Input/adjp_output_deps.txt', 'r')
line=f.readlines()
...
f=open('D:/Onlab/ADJP_generalas/Input/adjp_output.txt', 'r')
adjplist=f.readlines()
...
def write_file(output):
    f = open('D:/Onlab/OUTPUT_eredeti2.irtg', 'a')
    f.write(output)

def gen_output():
    f = open('D:/Onlab/OUTPUT_eredeti2.irtg', 'w')
