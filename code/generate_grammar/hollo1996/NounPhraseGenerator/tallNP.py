...
def tallBinaryNPADJP():
    reverse = False
    connected = False
    sameType = False

    result = ""
    datas = Data.fromFile("Data/Input/NP/np_2x2_adjp_trees", "Data/Input/NP/np_2x2_adjp_terms", "Data/Input/NP/np_2x2_adjp_deps", 7)
    uniqData = {}
...
def tallTernaryNPADJPTail():
    reverse = False
    connected = False
    sameType = False

    result = ""
    datas = Data.fromFile("Data/Input/NP/np_2x3_adjp_trees", "Data/Input/NP/np_2x3_adjp_terms", "Data/Input/NP/np_2x3_adjp_deps", 23)
    for input in datas:
